...
I don't have many opportunities to build an interactive dashboard. Most of time, I work on developing new algorithms and building helper functions and libraries so that I can help standardize data workflow, analysis and documentation. If we need to scale up and deploy them, our software engineers colleagues will jump in, translate and optimize the codes. 

Occasionally I need to build an interactive dashboard for training and for our sale/marketing teams. By doing this final project, I have a chance to practice more in programming UI and realize there are some interesting things I can explore further in the future.
