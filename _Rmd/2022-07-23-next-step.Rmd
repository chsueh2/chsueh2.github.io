...
I only used interactive notebook when I coded in Python. For any works with R codes, I did it on R scripts with `source()` like the include headers and preprocess macro in C/C++. This makes it possible to load or run some codes in a dynamic manner depending on tasks. However, it makes codes hard to share with others.
